...
public class UpdateData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserDataResponse dataResponse = (UserDataResponse) getIntent().getExtras().getSerializable("USERDATARESPONSE");
        databaseHelper = new DatabaseHelper(this);


        updateId.setText(dataResponse.getId());
        updateName.setText(dataResponse.getName());
        updateAge.setText(dataResponse.getAge());
        updateCity.setText(dataResponse.getCity());
        updatePhone.setText(dataResponse.getPhone());
        updateGmail.setText(dataResponse.getGmail());
        updatePassword.setText(dataResponse.getPassword());
